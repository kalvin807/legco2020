...
function FCStackedBar({ data }) {
    ...
    useEffect(() => {
        ...
        const last_election_no_vote = data.electors_total_2016 - data.last_election_voted_count
        const electors_2020_minus_2016 = data.electors_total_2020 - data.electors_total_2016
        ...
        const _data = [
            {
            value: electors_2020_minus_2016,
            cumulative: 0,
            label: 'electors_2020_minus_2016',
            color: theme.palette.success.main
            },
            {
            value: last_election_no_vote,
            cumulative: electors_2020_minus_2016,
            label: 'last_election_no_vote',
            color: theme.palette.action.disabled
            }
        ]

        const total = electors_2020_minus_2016 + last_election_no_vote
